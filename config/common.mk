...
ifeq ($(HOST_OS),linux)
    ifneq ($(wildcard vendor/qcom/sdclang-4.0/),)
        include vendor/future/sdclang/sdclang.mk
    endif
endif
...
PRODUCT_COPY_FILES += \
    ...
    vendor/future/prebuilt/common/bin/50-base.sh:system/addon.d/50-base.sh \
...
# Fix Dialer
PRODUCT_COPY_FILES +=  \
    vendor/future/prebuilt/common/sysconfig/dialer_experience.xml:system/etc/sysconfig/dialer_experience.xml
...
# Weather client
PRODUCT_COPY_FILES += \
    vendor/future/prebuilt/common/etc/permissions/org.pixelexperience.weather.client.xml:system/etc/permissions/org.pixelexperience.weather.client.xml \
    vendor/future/prebuilt/common/etc/default-permissions/org.pixelexperience.weather.client.xml:system/etc/default-permissions/org.pixelexperience.weather.client.xml
...
# Common overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/future/overlay/common

# Bootanimation
include vendor/future/config/bootanimation.mk

# Packages
include vendor/future/config/packages.mk

# Versioning
include vendor/future/config/version.mk

# Accents
include vendor/future/config/accents.mk

# Themes
include vendor/future/config/themes.mk
